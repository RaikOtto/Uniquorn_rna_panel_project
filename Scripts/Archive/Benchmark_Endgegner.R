...
run_small_statistics = function( 
  ...
  type_benchmark = type_benchmark
    ...
    source("~/Dropbox/PhD/Uniquorn_project/Scripts/utility.R")
    source("~/Dropbox/PhD/Uniquorn_project/Scripts/Benchmark_Merger_Skript_Relaxed.R")
    build_path_variables( 
        inclusion_weight = inclusion_weight, 
        only_first = only_first, 
        exclude_self = exclude_self, 
    ...
    if (type_benchmark == "regularized"){
        ...
        "/Users/raikotto/Uniquorn_data/benchmark_vcf_files/Benchmark_results_regularized/1_Benchmark_comparisons_result.tab"
        input_path_identification = 
          "/Users/raikotto/Uniquorn_data/benchmark_vcf_files/Benchmark_results_regularized/1_Benchmark_identification_result.tab"
    }
    
    if (type_benchmark == "non_regularized"){
        
        input_path_comparison = 
        "/Users/raikotto/Uniquorn_data/benchmark_vcf_files/Benchmark_results_non_regularized/1_Benchmark_comparisons_result.tab"
        input_path_identification = 
          "/Users/raikotto/Uniquorn_data/benchmark_vcf_files/Benchmark_results_non_regularized/1_Benchmark_identification_result.tab"
    }
    
    input_path_comparison = str_replace( input_path_comparison, "1", replacement = inclusion_weight  )
    input_path_identification = str_replace( input_path_identification, "1", replacement = inclusion_weight  )
