...
calculate_p_and_q_values = function(
    ...
    p_values = rep(1.0, nrow(sim_list_stats))
    
    for (panel in panels){
    
        index_panel = sim_list_stats[, CL %like% panel]
        white_balls_possible = sim_list_stats$Count[index_panel]
        ...
        white_balls_found = candidate_hits_abs_all[index_panel]
        ...
        p_values[index_panel] = p_values_panel
