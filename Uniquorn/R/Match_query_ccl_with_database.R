match_query_ccl_to_database = function(
    ...
    cl_ids = as.character(unlist(str_split(mcols(match)$Member_CCLs, pattern = "," )))
    ...
    cl_ids_all = str_replace_all( mcols(g_mat)$Member_CCLs, pattern = paste("_",library_name,sep = ""),"" )
